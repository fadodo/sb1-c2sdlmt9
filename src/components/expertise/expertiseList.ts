...
export const expertiseList = [
  ...
  },
  {
    ...
    description: "Smart city, aménagement territoire, services aux citoyens",
  },
  {
    Icon: GraduationCap,
    title: "Secteur Académique",
    description: "Recherche, analyse de données scientifiques, collaboration académique",
  },
  {
    Icon: Heart,
    title: "ONG",
